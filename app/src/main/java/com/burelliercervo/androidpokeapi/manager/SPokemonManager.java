...
public class SPokemonManager {
    private static SPokemonManager instance;
    ...
    private SPokemonManager() {
        //empty constructor
    }

    public static SPokemonManager getInstance() {
        if (instance == null) {
            instance = new SPokemonManager();
